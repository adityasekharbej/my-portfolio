...
import homedrop from "./assets/images/homedrop-logo.svg";
...
const greeting = {
    ...
    subTitle: emoji(
        "A passionate Full Stack Web Developer 🚀 having an experience of designing and building Web applications with HTML5, CSS3, JavaScript, React.js, Node.js, Express.js, Electron.js, MongoDB and RealmDB."
    ),
    resumeLink: "https://drive.google.com/file/d/1qeMvbOSTBatJKsrex2AkcThRIBrxIqJy/view?usp=sharing",
...
const skillsSection = {
    ...
    skills: [
        emoji("⚡ Develope highly interactive Front-end / User Interfaces for your web applications."),
    ...
    experience: [
        {
            ...
            company: "HomeDrop",
            companylogo: homedrop,
            date: "October 2022 – February 2024",
            desc: "The company offers a comprehensive solution for businesses, POS solutions, online store setup, and various integrated features such as GST and non-GST billing, accounting, inventory management, and analytics.",
            descBullets: [
                "Developed and maintained a Point of Sale (POS) software using the MERN stack, catering to the specific needs of the retail industry.",
                "Oversaw project planning, resource allocation, and lead in the successful execution and delivery of the POS software.",
                "Conceptualized and implemented core features, including user authentication, inventory management, sales, and purchases.",
                "Developed RESTful APIs for seamless communication between the front-end and back-end systems, improving overall application performance.",
            ],
        },
        {
            ...
            desc: "Rourkela Steel Plant (RSP), the first integrated steel plant in the public sector in India, was set up with German collaboration",
            descBullets: [],
        },
    ],
};
...
const bigProjects = {
    ...
    projects: [
        ...
        },
        {
            ...
            projectDesc: "Inspired from unsplash.com, a photo discovery platform.  made with JavaScript , HTML, and CSS .",
            footerLink: [
                {
                    name: "Visit Website",
